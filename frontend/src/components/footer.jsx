...
const Footer = () => {
    return (
        <footer className="bg-gray-100 mt-[10rem] py-8">
            <div className="max-w-7xl mx-auto px-4 flex flex-wrap justify-between items-start gap-8">
                ...
                <div className="flex-1 min-w-[200px] text-center md:text-left">
                    <h4 className="text-lg font-semibold text-pink-600 mb-2">ABOUT US</h4>
                ...
                {/* C/S CENTER */}
                <div className="flex-1 min-w-[200px] text-center md:text-left">
                    <h4 className="text-lg font-semibold text-pink-600 mb-2">C/S CENTER</h4>
